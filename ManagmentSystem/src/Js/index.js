...
const margherita = new Pizza(
  "Margherita",
  "Pizza sauce, gouda cheese, mozzarella cheese, tomatoes",
  7.9,
  "./assets/images/pizzas-section/margherita.jpg"
);
const vegetarian = new Pizza(
  "Vegetarian",
  "Pizza sauce, gouda cheese, spinach, red onion, bell pepper, tomatoes, mushrooms",
  8.9,
  "./assets/images/pizzas-section/vegetarian.jpg"
);
const funghiConPollo = new Pizza(
  "Funghi Con Pollo",
  "Pizza sauce, gouda cheese, mushrooms, chicken fillet",
  9.9,
  "./assets/images/pizzas-section/funghi-pollo.jpg"
);
const speciale = new Pizza(
  "Speciale",
  "Pizza sauce, gouda cheese, chicken fillet, red onion",
  9.9,
  "./assets/images/pizzas-section/speciale.jpg"
);
const mista = new Pizza(
  "Mista",
  "Pizza sauce, gouda cheese, mushrooms, ham (halal), salami (halal)",
  9.9,
  "./assets/images/pizzas-section/mista.jpg"
);
const salami = new Pizza(
  "Salami",
  "Pizza sauce, gouda cheese, salami (halal)",
  9.9,
  "./assets/images/pizzas-section/salami.jpg"
);
const classico = new Pizza(
  "Classico",
  "Pizza sauce, gouda cheese, salami (halal), mushrooms, pepperoni pepper",
  9.9,
  "./assets/images/pizzas-section/classico.jpg"
);
const hawaii = new Pizza(
  "Hawaii",
  "Pizza sauce, gouda cheese, pineapple, ham (halal)",
  9.9,
  "./assets/images/pizzas-section/hawaii.jpg"
);
const texas = new Pizza(
  "Texas",
  "Pizza sauce, gouda cheese, chicken fillet, bell pepper, corn, red onion",
  9.9,
  "./assets/images/pizzas-section/texas.jpg"
);
const chickenStrips = new Pizza(
  "Chicken Strips",
  "Barbecue sauce, gouda cheese, chicken nuggets, corn, bell pepper",
  10.9,
  "./assets/images/pizzas-section/chicken-strips.jpg"
);
const mexicana = new Pizza(
  "Mexicana",
  "Pizza sauce, gouda сheese, chicken fillet, red onion, spinach, jalapeno pepper, pepperoni",
  10.9,
  "./assets/images/pizzas-section/mexicana.jpg"
);
const tonnoeCipolla = new Pizza(
  "Tonno e Cipolla",
  "Pizza sauce, gouda cheese, tuna, red onion",
  10.9,
  "./assets/images/pizzas-section/tonno-cipolla.jpg"
);
const fiveChesees = new Pizza(
  "Five Chesees",
  "Creamy sauce, gouda cheese, mozzarella cheese, bufallo mozzarella cheese, riccota cheese, parmesan cheese",
  11.9,
  "./assets/images/pizzas-section/five-chesees.jpg"
);
const volcano = new Pizza(
  "Volcano",
  "Pizza sauce, gouda cheese, spinach, red onion, bell pepper, tomatoes, mushrooms, chicken fillet, olives",
  11.9,
  "./assets/images/pizzas-section/volcano.jpg"
);
const sujuk = new Pizza(
  "Sujuk",
  "Pizza sauce, gouda сheese, bell pepper, mushrooms, sucuk",
  11.9,
  "./assets/images/pizzas-section/sujuk.jpg"
);
const amerikana = new Pizza(
  "Amerikana",
  "Barbecue sauce, gouda сheese, sausage, french friez, pickles",
  11.9,
  "./assets/images/pizzas-section/amerikana.jpg"
);
const fourSeasons = new Pizza(
  "Four Seasons",
  "Meduim - 30 sm, pizza sauce, gouda cheese, white cheese, ham (halal), sucuk, mushrooms, tomatoes, oregano",
  16.9,
  "./assets/images/pizzas-section/four-season.jpg"
);
const deluxe = new Pizza(
  "Deluxe",
  "Pizza sauce, gouda cheese, red onion, pepperoni pepper, beef",
  11.9,
  "./assets/images/pizzas-section/deluxe.jpg"
);
const meatLovers = new Pizza(
  "Meat Lovers",
  "Pizza sauce, gouda cheese, chicken fillet, beef, salami (halal), ham (halal), sucuk",
  12.9,
  "./assets/images/pizzas-section/meat-lovers.jpg"
);
const megaMix = new Pizza(
  "Mega Mix",
  "Pizza sauce, gouda сheese, tomatoes, bell pepper, mushrooms, black olives, salami (halal), ham (halal), beef, chicken fillet",
  12.9,
  "./assets/images/pizzas-section/mega-mix.jpg"
);
...
for (let i = 0; i < chooseButtons.length; i++) {
  ...
  chooseBtn.addEventListener("click", () => {
    ...
    const namePizza = document.querySelector(
      ".clicked .pizza-body .card-title"
    ).innerText;
...
const basketError = document.querySelector(".basket-error");
const basketDiv = document.querySelector(".basket");
const checkSummary = document.querySelector(".result-value h5");
basketBtn.addEventListener("click", () => {
  if (basket[0] === undefined) {
    basketError.innerHTML = "Your basket is empty!";
  } else {
    const sections = document.querySelectorAll("section");
    ...
    sliderSec.classList.add("d-none");
    ...
    checkSummary.innerHTML += priceTotal;
    const removeButton = document.querySelectorAll("#basket .remove-btn");

    removeButton.forEach((e) => {
      e.addEventListener("click", () => {
        let priceNewTotal = totalPrice(basket);
        e.parentElement.parentElement.classList.add("d-none");
        console.log(
          e.parentElement.parentElement.children[2].children[2].innerText
        );
        ...
        totalPriceH.innerText = `Total value: ${priceTotal}`;
        checkSummary.innerText = `Checkout summary: ${priceTotal}`;
      });
    });
  }
});
...
//Order-register
// ----------------------------------------------------------------------------------------
const orderRegister = document.querySelector(".order-register");
